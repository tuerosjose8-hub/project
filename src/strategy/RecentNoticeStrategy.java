...
public class RecentNoticeStrategy implements NoticeFilterStrategy {
		
	public ArrayList<Notice> getNotices(NoticeRepository noticeRepository, int limit, String studentYear) {
			
		if(studentYear == null) {
			return noticeRepository.getRecent(limit);
		}

		return noticeRepository.getStudentRecent(limit, studentYear);
	}
}